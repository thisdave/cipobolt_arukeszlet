...
static const char qt_meta_stringdata_SearchDlg[] = {
    "SearchDlg\0\0expression\0searchInvoked(QString)\0"
    "search()\0"
};
...
void SearchDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->searchInvoked((*reinterpret_cast< QString(*)>(_a[1]))); break;
...
const QMetaObjectExtraData SearchDlg::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SearchDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SearchDlg,
      qt_meta_data_SearchDlg, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SearchDlg::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SearchDlg))
...
// SIGNAL 0
void SearchDlg::searchInvoked(QString _t1)
{
